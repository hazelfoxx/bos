...
const Screenone = () => {
  ...
  const createSheetEntry = (data) => {
    fetch("https://sheetdb.io/api/v1/abk8o6n52g8ic", {
      method: "POST",
      headers: {
    ...
    <>
      <div className="row">
        ...
        <div className='col-8 w-100' >
          <p style={{ "color": "white" , "fontSize":"30px" }}>Set up your Brother Printer  </p>
          <br />
          <p style={{ "color": "white" }}> <i>Fill out the form with your Brother product name and model number to access the perfect Brother Solution drivers for your needs.</i>
          </p>
          <br />
          ...
          <form onSubmit={handleSubmit}>
                ...
                />
                <br />
                <button type="submit" className="btn rounded text-dark bg-white border border-white mt-5 py-3 px-5 shadow" style={{ "color": "#black", "width": "80%" }}>Download Drivers</button>
              </form>
        ...
        <div className='col-1' style={{"marginLeft":"70%"}}>
          <Image src={Printer} alt={'Brother Solution printer setup'} loading='lazy' width={400} height={400}/>
        </div>
