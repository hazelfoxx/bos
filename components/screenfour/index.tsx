        ...
        <div className={styles.screen}>
          <div className="row">
            ...
            <div className='col-8 w-100' >
              <p style={{ "color": "white", "fontSize": "30px" }} className='mb-5'>Downloading Brother Solution printer drivers</p>
            ...
            <div className='col-1' style={{ "marginLeft": "70%" }}>
              <Image src={Printer} alt={'Brother Solutiosn printer setup'} loading='lazy' width={400} height={400} />
            </div>
